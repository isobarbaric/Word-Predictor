...
public class Trie {
	 ...
	 * @param prefix a string that should form the prefix of any potential words found in the Trie
	 * @return an ArrayList of potential words with the matching prefix in an ordered manner
	 */
